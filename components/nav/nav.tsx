  ...
  return (
    <nav className={styles.NavContainer}>
        ...
        <ul className={`${styles.NavSlideMen} ${isOpen ? styles.active : ""}`}>
          <li className={styles.desktopOnly}>
            ...
            <ul className={styles.Dropdown}>
              <li>
                <Link href="/oferta/uzywane" onClick={closeMenu}>
                  Używane
                </Link>
              </li>
              <li>
                <Link href="/oferta/nowe" onClick={closeMenu}>
                  Nowe
                </Link>
              </li>
            </ul>
          ...
          <li>
            <Link href="/onas" onClick={closeMenu}>
              O nas
            </Link>
          </li>
      ...
      <div className={styles.Buttons}>
        <Link href="/admin/login" className={styles.signIn} onClick={closeMenu}>
          Zaloguj się
        </Link>
      </div>
    </nav>
